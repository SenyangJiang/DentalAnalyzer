...
#if (0)
// compute halfedge normal : ajout C�line
...
public:
...
#if (0)
		compute_normals_per_halfedge(); // ajout C�line
#endif
	}
	...
	bool load_mesh(string path)
	{
		...
		/*MEPP: if (extension != "DAT" && extension != "BW")  // ajout C�line
				this->fit_mesh();*/
...
protected:
	...
	bool load_mesh_dat(string filename)
	{
		...
		// on r�cup�re le nombre de niveaux de r�solution du poly�dre semi-r�gulier :
